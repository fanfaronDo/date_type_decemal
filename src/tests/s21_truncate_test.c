...
//   s21_decimal a = {{-2018871682, 41499, 0, -2147352576}};  //
//   -1782391239123.18 s21_decimal res_bits = {{0, 0, 0, 0}};
...
Suite *s21_truncate_suite(void) {
  ...
  //  tcase_add_test(o, s21_truncate_test_15);
  //  tcase_add_test(o, s21_truncate_test_16);
