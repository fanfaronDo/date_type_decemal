...
Suite* s21_add_suite(void) {
  ...
  tcase_add_test(o, s21_add_test_33);  // HARD TEST
  tcase_add_test(o, s21_add_test_34);  // HARD TEST
  tcase_add_test(o, s21_add_test_35);  // HARD TEST
  tcase_add_test(o, s21_add_test_36);  // HARD TEST
